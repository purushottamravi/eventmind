...
/**
 * Proves the query service filters, pages, and maps symptoms properly, so the
 * read model answers actually make sense.
 */
...
class SymptomQueryServiceTest {
    ...
    @Test
    void findSymptoms_shouldFilterByNameWhenNameProvided() {
        SymptomQueryService service = new SymptomQueryService(repository);
        ...
        List<SymptomRestModel> result = service.findSymptoms("headache", 0, 20);
    ...
    @Test
    void findSymptoms_shouldReturnAllWhenNoNameProvided() {
        SymptomQueryService service = new SymptomQueryService(repository);
        ...
        List<SymptomRestModel> result = service.findSymptoms(null, 0, 20);

        assertEquals(2, result.size());
    }

    @Test
    void findSymptoms_shouldReturnEmptyListWhenNothingMatches() {
        SymptomQueryService service = new SymptomQueryService(repository);
        ...
        List<SymptomRestModel> result = service.findSymptoms("zzz", 0, 20);

        assertTrue(result.isEmpty());
    }

    @Test
    void findSymptoms_shouldApplyPagination() {
        SymptomQueryService service = new SymptomQueryService(repository);
        ...
        List<SymptomRestModel> result = service.findSymptoms(null, 0, 1);
